...
import uas.transaksi.dao.IShipmentDao; // Import interface
import uas.transaksi.dao.ISenderDao; // Import interface
import uas.transaksi.dao.IReceiverDao; // Import interface
import uas.transaksi.factory.DaoFactory; // Import DaoFactory
...
public class ShipmentDaoImpl implements IShipmentDao { // Implement interface

    // Ganti ke interface, dan inisialisasi via DaoFactory
    private ISenderDao senderDao;
    private IReceiverDao receiverDao;

    public ShipmentDaoImpl() {
        // Inisialisasi DAO terkait via Factory Method
        this.senderDao = DaoFactory.getSenderDao();
        this.receiverDao = DaoFactory.getReceiverDao();
    }
